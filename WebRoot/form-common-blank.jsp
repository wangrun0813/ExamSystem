					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="teacher/blank" method="post" class="form-horizontal" />
								<input type="hidden" name="chapterTypeName" value="填空">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="help-block">请在此输入正确答案</span>
										</div>
									</div>
