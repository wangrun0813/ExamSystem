				...
				<div class="widget-box">
							...
							<div class="widget-content">
								<table class="table table-bordered table-striped with-check" >
									...
									<tbody >
									 	<c:forEach items="${textpaperlist}" var="tex">
										<tr>
										
											<td>${tex.exampaperId}</td>
											<td>${tex.exampaperName}</td>
											<td>${tex.exampaperTime}</td>
											<td>${tex.fullgrade}</td>
										    <td ><a href="teacher/choosepaper?exampaperId=${tex.exampaperId}">确定</a></td> 
										    <td><a href="teacher/deletepaper?exampaperId=${tex.exampaperId}">确定</a></td>
										</tr>
									</c:forEach>
									</tbody>
								</table>							
